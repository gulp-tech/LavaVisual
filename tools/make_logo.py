...
Outputs (mod resources):
  ...
  assets/lavavisual/textures/font/badge.png         LV glyph of the lavavisual:badge font (name tags)
...
def main():
    ...
    # Name-tag logo: the only glyph of the lavavisual:badge bitmap font (9 units tall, 4 texels per unit).
    badge_h = 36
    (RES / "textures/font").mkdir(parents=True, exist_ok=True)
    resized(logo, max(1, round(badge_h * aspect)), badge_h).save(RES / "textures/font/badge.png", optimize=True)
    JAVA.write_text(
