...
with log.open('w') as output:
    ...
    try:
        ...
        while time.monotonic() < deadline:
            ...
            if re.search(r'LavaVisual 2\.[0-9]+\.[0-9]+', text) and re.search(r'Created:.*(atlas|textures)', text) and 'LavaVisual UI smoke complete' in text and 'LavaVisual audio regression passed' in text and 'LavaVisual badge marker on' in text and 'LavaVisual hat sync self-test passed' in text and 'LavaVisual hats ready' in text and 'LavaVisual menu restore page 9' in text and 'LavaVisual smoke dummy ok' in text and 'LavaVisual smoke hand editor ok' in text and 'LavaVisual smoke zoom ok' in text and 'LavaVisual smoke freelook ok' in text and 'LavaVisual smoke minimap fast' in text and 'LavaVisual smoke custom sounds ok' in text and 'LavaVisual smoke music ok' in text and 'LavaVisual smoke formats ok' in text and 'LavaVisual smoke minimap fps ok' in text and 'LavaVisual smoke wings editor ok' in text and 'LavaVisual smoke time ok' in text and 'LavaVisual smoke item physics ok' in text and 'LavaVisual smoke projectile trails ok' in text and 'LavaVisual smoke outfit ok' in text and 'LavaVisual smoke trail clear ok' in text:
