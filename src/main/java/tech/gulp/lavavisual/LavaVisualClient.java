...
public final class LavaVisualClient implements ClientModInitializer {
    ...
    private final VertexConsumerProvider.Immediate lines = VertexConsumerProvider.immediate(new BufferBuilder(32768));
    ...
    private void render(WorldRenderContext context) {
        ...
        try {
            ...
            for (Entity entity : client.world.getEntities()) {
                ...
                Box b = RenderUtils.interpolatedBox(entity, context.tickDelta(), context.camera().getPos()).expand(0.04);
