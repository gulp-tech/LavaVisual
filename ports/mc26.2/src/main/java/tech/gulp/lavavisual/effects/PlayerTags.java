...
/** LavaVisual badge next to the name tag of other LavaVisual users who chose to share their mark (see Badge).
    Purely client-side: no custom packets or channels, so servers see a plain Fabric client. */
