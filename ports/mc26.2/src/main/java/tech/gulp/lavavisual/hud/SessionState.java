...
public final class SessionState {
    ...
    private long started, accumulated;
    private boolean running;
    public String coordinates = "X 0   Y 64   Z 0", performance = "FPS --";
    public void joined() { reset(); notify("Мир загружен"); }
    ...
    public void toggleTimer() {
        ...
        running = !running;
        notify(running ? "Секундомер запущен" : "Секундомер остановлен");
    }
