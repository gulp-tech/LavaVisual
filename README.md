# LavaVisual 2.3 — Minecraft 26.2

**[Скачать lavavisual-2.3.0-mc26.2.jar](artifacts/lavavisual-2.3.0-mc26.2.jar)**

Клиентский HUD и косметика. Тёмное меню со стандартным шрифтом Minecraft,
...
| Вкладка | Возможности |
| --- | --- |
| HUD | Координаты, FPS, Target HUD. Стрелка справа — размер, плотность фона и удержание цели; редактор — перетаскивание. |
...
| RGB / UI | Каналы R/G/B, образец цвета, масштаб/непрозрачность меню, затемнение мира, тени, анимации. |
| Мир / FPS | Редактор оттенка неба и FPS Boost (8 чанков, меньше частиц, без теней сущностей) с возвратом прежних значений. |
