...
| Мир / FPS | Редактор неба с готовыми пресетами (закат, неон, изумруд, алый, бездна) и FPS Boost с возвратом прежних значений. |
...
- Иконка-ромб над головой игроков, у которых тоже включён LavaVisual (работает,
  когда сервер маршрутизирует канал мода: одиночная игра/LAN и Fabric-серверы).
