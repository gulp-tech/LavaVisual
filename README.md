# LavaVisual Beta 1.0.0 — Minecraft 26.2
...
| | Скачать | Что внутри |
| --- | --- | --- |
| **Мод** | [lavavisual-1.0.0-beta-mc26.2.jar](artifacts/lavavisual-1.0.0-beta-mc26.2.jar) | только LavaVisual, в папку `mods` |
| **Клиент** | [LavaVisual-Client-1.0.0-beta-mc26.2.mrpack](artifacts/LavaVisual-Client-1.0.0-beta-mc26.2.mrpack) | готовая сборка для Modrinth App, Prism Launcher, ATLauncher |
| **Клиент (архив)** | [LavaVisual-Client-1.0.0-beta-mc26.2.zip](artifacts/LavaVisual-Client-1.0.0-beta-mc26.2.zip) | папки `mods` и `config` для TLauncher, телефонов и ручной установки |
...
3. Меню открывается кнопкой **LavaVisual** в главном меню и в меню паузы. Списки листаются пальцем.
...
- **Косметика:** 14 шляп и 5 видов объёмных крыльев с редакторами (размер, положение, взмахи, цвет), 6 плащей с
  ...
  Шляпы, крылья, плащи и аксессуары видят другие игроки с LavaVisual — без серверного мода.
